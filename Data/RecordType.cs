    ...
    namespace Bendyline.FlightSimulator.Data
{
    public enum RecordType
    {
        ...
        FS9VegetationDefinitionVGRD = 9,
        FS9RectangularVegetationAreaVGRO = 10,
        RectangularVegetationAreaVGRE = 11,
        RectangularVegetationAreasVGRG = 12,
        LibraryObjectsAGN2 = 13,
